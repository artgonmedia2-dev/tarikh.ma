    ...
    <div className="relative flex flex-col overflow-x-hidden bg-white">
      ...
      <section className="relative h-[420px] sm:h-[500px] flex items-center justify-center overflow-hidden bg-background-dark">
        ...
        <div className="relative z-10 max-w-4xl px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 leading-[1.1] tracking-tight text-slate-900 vintage-text-shadow serif">
            Les Époques : <br />
            <span className="text-accent-gold italic">Parcourir l&apos;histoire</span>
          </h1>
      ...
      <section className="flex flex-col lg:flex-row min-h-[400px] sm:min-h-[500px] bg-white">
        ...
        <div className="lg:w-1/2 bg-slate-50 border-t lg:border-t-0 lg:border-r border-slate-200 flex flex-col justify-center p-8 sm:p-12 lg:p-24 space-y-6 order-1 lg:order-2">
          <h2 className="text-3xl sm:text-4xl font-black font-serif italic text-accent-gold">
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <p className="text-accent-gold text-xs font-semibold">Plateforme nationale du patrimoine numérisé</p>
          </div>
        </div>
      </section>
