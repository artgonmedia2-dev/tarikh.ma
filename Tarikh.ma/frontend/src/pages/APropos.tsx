    ...
    <div className="relative flex flex-col overflow-x-hidden bg-white">
      ...
      <section className="relative h-[420px] sm:h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6 text-center">
          <span className="inline-block px-4 py-1.5 rounded-full bg-accent-gold/10 text-accent-gold font-bold text-[10px] uppercase tracking-[0.2em] mb-6">
            Institutionnel
          </span>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 leading-[1.1] tracking-tight text-slate-900">
            Notre Mission : <br />
            <span className="text-accent-gold italic font-serif">Porter l&apos;Héritage</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 py-16 sm:py-24 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          <div className="bg-white p-6 sm:p-8 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
            <div className="w-12 h-12 bg-accent-gold/10 rounded-lg flex items-center justify-center text-accent-gold mb-6 group-hover:bg-accent-gold group-hover:text-white transition-colors">
      ...
      <section className="bg-parchment sm:bg-slate-50/80 py-16 sm:py-24 px-6 sm:px-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14 sm:mb-20">
            <h2 className="text-3xl font-black mb-4 text-slate-900 italic serif">Genèse du Projet</h2>
            <div className="w-16 h-1.5 bg-accent-gold mx-auto rounded-full" />
          </div>
          <div className="relative space-y-12 sm:space-y-16">
            ...
            <div className="relative flex items-start gap-8 sm:gap-12 group">
              <div className="z-10 flex items-center justify-center w-16 h-16 rounded-full bg-accent-gold text-white shadow-lg ring-8 ring-white sm:ring-slate-50 transition-transform group-hover:scale-110">
                <span className="material-symbols-outlined text-2xl">lightbulb</span>
              </div>
              <div className="pt-2 min-w-0">
                <span className="text-accent-gold font-black text-sm uppercase tracking-tighter">
                  2021 — Phase d&apos;étude
                </span>
            ...
            {/* Step 2 */}
            <div className="relative flex items-start gap-8 sm:gap-12 group">
              <div className="z-10 flex items-center justify-center w-16 h-16 rounded-full bg-white text-accent-gold border-4 border-accent-gold shadow-lg ring-8 ring-white sm:ring-slate-50 transition-transform group-hover:scale-110">
      ...
      <section className="flex flex-col lg:flex-row min-h-[500px] sm:min-h-[600px] bg-white">
        ...
        <div className="lg:w-1/2 bg-slate-50 border-t lg:border-t-0 lg:border-l border-slate-200 flex flex-col justify-center p-8 sm:p-12 lg:p-24 space-y-6 sm:space-y-8">
          <h2 className="text-3xl sm:text-4xl font-black font-serif italic text-accent-gold">Un devoir de mémoire</h2>
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <p className="text-accent-gold text-xs font-semibold">Conservateur en Chef, Projet Tarikh</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 px-6 sm:px-10 text-center bg-white">
        <div className="max-w-2xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/archives"
              className="w-full sm:w-auto bg-accent-gold text-white px-10 py-5 rounded-xl font-bold hover:shadow-2xl hover:shadow-accent-gold/20 hover:brightness-110 transition-all text-center"
            >
