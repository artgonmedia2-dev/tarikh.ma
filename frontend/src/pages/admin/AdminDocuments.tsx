            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-800">
                  ...
                  <th className="p-4 font-bold text-slate-700 dark:text-slate-300">Région</th>
                  <th className="p-4 font-bold text-slate-700 dark:text-slate-300">Thème</th>
              ...
              <tbody>
                {data.data.map((doc) => (
                  <tr key={doc.id} className="border-b border-slate-100 dark:border-slate-800">
                    ...
                    <td className="p-4 text-sm">{doc.region?.name ?? '—'}</td>
                    <td className="p-4 text-sm">{doc.theme?.name ?? '—'}</td>
