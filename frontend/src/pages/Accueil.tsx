...
const CATEGORIES = [
  {
    title: 'Textes & Manuscrits',
    description: "Découvrez les traités, poèmes et écrits juridiques qui ont forgé la pensée marocaine.",
    icon: 'history_edu',
    ...
    to: '/archives?type=manuscrit',
  },
  {
    title: 'Photographies & Gravures',
    description: 'Un voyage visuel à travers les siècles, des premières gravures aux clichés du XXe siècle.',
    icon: 'image',
    ...
    to: '/archives?type=photo',
  },
  {
    title: 'Cartographie Ancienne',
    description: "Explorez l'évolution du territoire et des villes à travers des plans historiques.",
    icon: 'map',
