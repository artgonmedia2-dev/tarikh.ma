  ...
  return (
    <footer className="bg-white text-slate-800 pt-20 pb-10 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          <h4 className="font-bold mb-6 text-accent-gold uppercase tracking-widest text-xs">Dynasties</h4>
          <ul className="space-y-4 text-sm text-slate-600">
        ...
        <div>
          ...
          <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <button type="submit" className="bg-primary px-4 py-2 rounded-lg text-xs font-bold text-white hover:bg-primary/80 transition-colors">
              Ok
            </button>
          </form>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-[10px] text-slate-400 uppercase tracking-widest text-center md:text-left">
          © {new Date().getFullYear()} Tarikh.ma - Tous droits réservés. <br /> Direction des Archives Royales.
        </p>
